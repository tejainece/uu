...
func (s *MySuite) TestConv3Bytes1(c *check.C) {
	lRes := Conv3Bytes([3]byte{0x14, 0x0F, 0xA8})
	c.Check(lRes, check.Equals, [4]byte{0x25, 0x20, 0x5E, 0x48})
}

//TestFindLevel tests hello world
func (s *MySuite) TestConv3Bytes2(c *check.C) {
	lRes := Conv3Bytes([3]byte{0x17, 0x00, 0x00})
	c.Check(lRes, check.Equals, [4]byte{0x25, 0x50, 0x20, 0x20})
}

//TestFindLevel tests hello world
func (s *MySuite) TestEncodeLineInvalidLen(c *check.C) {
...
//TestFindLevel tests hello world
func (s *MySuite) TestEncodeLine3Bytes(c *check.C) {
...
//TestFindLevel tests hello world
func (s *MySuite) TestEncodeLine4Bytes(c *check.C) {
...
//TestFindLevel tests hello world
func (s *MySuite) TestEncodeLine1(c *check.C) {
